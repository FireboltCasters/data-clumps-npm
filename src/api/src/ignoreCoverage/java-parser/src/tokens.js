"use strict";
import * as chars from "./unicodesets";
...
function createToken(options) {
  ...
  allTokensHolder.push(newTokenType);
...
allTokensHolder.push(Identifier);
...
/**
module.exports = {
  allTokens: allTokensHolder,
  tokens: tokenDictionary
};
 */

export const allTokens = allTokensHolder;
