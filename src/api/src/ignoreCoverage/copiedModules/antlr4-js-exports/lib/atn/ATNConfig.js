...
class ATNConfig {
  ...
  constructor(params, config) {
    ...
    this.semanticContext = params.semanticContext !== null ? params.semanticContext : config.semanticContext !== null ? config.semanticContext : _SemanticContext.default.NONE;
