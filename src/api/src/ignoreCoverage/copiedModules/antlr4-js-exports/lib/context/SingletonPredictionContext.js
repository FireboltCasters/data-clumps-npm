...
class SingletonPredictionContext extends _PredictionContext.default {
  ...
  toString() {
    ...
    if (up.length === 0) {
      if (this.returnState === _PredictionContext.default.EMPTY_RETURN_STATE) {
        return "$";
      } else {
        return "" + this.returnState;
      }
  ...
  static create(parent, returnState) {
    if (returnState === _PredictionContext.default.EMPTY_RETURN_STATE && parent === null) {
