...
function mergeArrays(a, b, rootIsWildcard, mergeCache) {
  if (mergeCache !== null) {
    ...
    if (previous !== null) {
      if (_PredictionContext.default.trace_atn_sim) console.log("mergeArrays a=" + a + ",b=" + b + " -> previous");
      return previous;
    }
  ...
  while (i < a.returnStates.length && j < b.returnStates.length) {
    ...
    if (a.returnStates[i] === b.returnStates[j]) {
      ...
      // $+$ = $
      const bothDollars = payload === _PredictionContext.default.EMPTY_RETURN_STATE && a_parent === null && b_parent === null;
  ...
  if (k < mergedParents.length) {
    ...
    if (k === 1) {
      ...
      const a_ = _SingletonPredictionContext.default.create(mergedParents[0], mergedReturnStates[0]);
      if (mergeCache !== null) {
  ...
  const M = new _ArrayPredictionContext.default(mergedParents, mergedReturnStates);
  ...
  if (M.equals(a)) {
    ...
    if (_PredictionContext.default.trace_atn_sim) console.log("mergeArrays a=" + a + ",b=" + b + " -> a");
    return a;
  }
  if (M.equals(b)) {
    if (mergeCache !== null) {
    ...
    if (_PredictionContext.default.trace_atn_sim) console.log("mergeArrays a=" + a + ",b=" + b + " -> b");
    return b;
  }
  ...
  if (_PredictionContext.default.trace_atn_sim) console.log("mergeArrays a=" + a + ",b=" + b + " -> " + M);
  return M;
}
...
function combineCommonParents(parents) {
  const uniqueParents = new _HashMap.default();
...
function mergeSingletons(a, b, rootIsWildcard, mergeCache) {
  ...
  if (a.returnState === b.returnState) {
    ...
    const spc = _SingletonPredictionContext.default.create(parent, a.returnState);
    if (mergeCache !== null) {
    ...
    if (singleParent !== null) {
      ...
      const apc = new _ArrayPredictionContext.default(parents, payloads);
      if (mergeCache !== null) {
    ...
    const a_ = new _ArrayPredictionContext.default(parents, payloads);
    if (mergeCache !== null) {
      mergeCache.set(a, b, a_);
    }
    return a_;
...
function mergeRoot(a, b, rootIsWildcard) {
  if (rootIsWildcard) {
    ...
    if (a === _PredictionContext.default.EMPTY && b === _PredictionContext.default.EMPTY) {
      ...
      // $ + x = [$,x]
      const payloads = [b.returnState, _PredictionContext.default.EMPTY_RETURN_STATE];
      const parents = [b.parentCtx, null];
      return new _ArrayPredictionContext.default(parents, payloads);
    } else if (b === _PredictionContext.default.EMPTY) {
      // x + $ = [$,x] ($ is always first if present)
      const payloads = [a.returnState, _PredictionContext.default.EMPTY_RETURN_STATE];
