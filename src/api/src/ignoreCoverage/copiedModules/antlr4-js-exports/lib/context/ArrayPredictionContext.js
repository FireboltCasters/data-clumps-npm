...
class ArrayPredictionContext extends _PredictionContext.default {
  ...
  isEmpty() {
    ...
    return this.returnStates[0] === _PredictionContext.default.EMPTY_RETURN_STATE;
  }
  getParent(index) {
  ...
  toString() {
    if (this.isEmpty()) {
      ...
      for (let i = 0; i < this.returnStates.length; i++) {
        ...
        if (this.returnStates[i] === _PredictionContext.default.EMPTY_RETURN_STATE) {
          s = s + "$";
          continue;
        }
