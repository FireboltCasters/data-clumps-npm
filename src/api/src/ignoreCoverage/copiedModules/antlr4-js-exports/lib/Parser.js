...
class Parser extends _Recognizer.default {
  /**
  ...
  constructor(input) {
     ...
     */
    this._errHandler = new _DefaultErrorStrategy.default();
  ...
  getATNWithBypassAlts() {
    ...
    if (result === null) {
      const deserializationOptions = new _ATNDeserializationOptions.default();
