...
var _TokenStream = _interopRequireDefault(require("./TokenStream.js"));
 ...
 */
class BufferedTokenStream extends _TokenStream.default {
  ...
  getHiddenTokensToRight(tokenIndex, channel) {
    ...
    const nextOnChannel = this.nextTokenOnChannel(tokenIndex + 1, _Lexer.default.DEFAULT_TOKEN_CHANNEL);
  ...
  getHiddenTokensToLeft(tokenIndex, channel) {
    ...
    const prevOnChannel = this.previousTokenOnChannel(tokenIndex - 1, _Lexer.default.DEFAULT_TOKEN_CHANNEL);
