...
class DFA {
  constructor(atnStartState, decision) {
    ...
    if (atnStartState instanceof _StarLoopEntryState.default) {
      if (atnStartState.isPrecedenceDecision) {
        ...
        const precedenceState = new _DFAState.default(null, new _ATNConfigSet.default());
  ...
  toString(literalNames, symbolicNames) {
    ...
    const serializer = new _DFASerializer.default(this, literalNames, symbolicNames);
  ...
  toLexerString() {
    ...
    const serializer = new _LexerDFASerializer.default(this);
    return serializer.toString();
  }
  get states() {
    return this._states;
