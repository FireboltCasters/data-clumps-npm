...
var _ErrorStrategy = _interopRequireDefault(require("./ErrorStrategy.js"));
 ...
 */
class DefaultErrorStrategy extends _ErrorStrategy.default {
  constructor() {
    super();
    /**
      ...
      case _ATNState.default.STAR_LOOP_BACK:
        {
          ...
          const expecting = new _IntervalSet.default();
  ...
  getErrorRecoverySet(recognizer) {
    ...
    const recoverSet = new _IntervalSet.default();
