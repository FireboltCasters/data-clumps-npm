...
var _Recognizer = _interopRequireDefault(require("./Recognizer.js"));
 ...
 */
class Lexer extends _Recognizer.default {
  constructor(input) {
    super();
    this._input = input;
    this._factory = _CommonTokenFactory.default.DEFAULT;
  ...
  emitEOF() {
    ...
    const eof = this._factory.create(this._tokenFactorySourcePair, _Token.default.EOF, null, _Token.default.DEFAULT_CHANNEL, this._input.index, this._input.index - 1, lpos, cpos);
    this.emitToken(eof);
    return eof;
  }
