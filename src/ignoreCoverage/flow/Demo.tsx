...
import {SoftwareProject, TestCasesDataClumpsJava} from "../../api/src/";
...
export const Demo : FunctionComponent = (props) => {
    ...
    // @ts-ignore
    const [code, setCode] = useState<string>(TestCasesDataClumpsJava.Positives.SimpleFields[0].content);
